...
async def get_available_models():
    """Retorna os modelos disponíveis para cada provedor - Apenas versões ESTÁVEIS."""
    return {
        "openai": [
            # GPT-4o Series (Estáveis)
